...
public class AntPathMatcher implements PathMatcher {
    ...
    public AntPathMatcher(String pathSeparator) {
        checkNotNull(pathSeparator, "'pathSeparator' is required");
    ...
    public Map<String, String> extractUriTemplateVariables(String pattern, String path) {
        ...
        checkState(result, "Pattern \"" + pattern + "\" is not a match for \"" + path + "\"");
        return variables;
    }
    ...
    /**
     * Tests whether or not a string matches against a pattern via a {@link java.util.regex.Pattern}.
        ...
        public boolean matchStrings(String str, Map<String, String> uriTemplateVariables) {
            ...
            if (matcher.matches()) {
                if (uriTemplateVariables != null) {
                    // SPR-8455
                    checkState(this.variableNames.size() == matcher.groupCount(),
    ...
    /**
     * The default {@link java.util.Comparator} implementation returned by
